...
function criarListagemTabela(jsonDados) {
    ...
    tabela += '<th scope="col">Endereço</th><th scope="col">Instagram</th><th scope="col"></th></tr></thead><tbody>';
    ...
    $.each(
        ...
        function(indice, contato) {
            ...
            tabela += '<td>' + contato.instagram + '</td>';
...
function getFormularioInclusao() {
    ...
    form += '</div>';
    form += '<div class="form-group">';
    form += '<label for="instagram" class="col-sm-2 control-label glyphicon glyphicon-link"></label>';
    form += '<div class="col-sm-8">';
    form += '<input type="text" class="form-control" id="instagram" placeholder="Instagram">';
    form += '</div>';
    form += '</div>';
    form += '<div class="form-group">';
...
function salvarContato(){
    ...
    Contato.instagram = $('input#instagram').val();
...
function getFormularioEdicao(jsonDado) {
    ...
    $
        ...
        function(indice, contato) {
            ...
            form += '<label for="instagram" class="col-sm-2 control-label glyphicon glyphicon-link"></label>';
            form += '<div class="col-sm-8">';
            form += '<input type="text" class="form-control" id="instagram" placeholder="Instagram" value="'
                +contato.instagram + '">';
            form += '</div>';
            form += '</div>';
            form += '<div class="form-group">';
